module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Raiden",
	description: "Nhận 500$ mỗi 1 Giờ!",
	commandCategory: "1",
    cooldowns: 5,
    envConfig: {
...
module.exports.languages = {
    "vi": {
        "cooldown": "Bạn đang trong thời gian chờ,vui lòng thử lại sau: %1 giờ %2 phút %3 giây!",
        "rewarded": "Bạn đã nhận %1$, để có thể tiếp tục nhận, vui lòng quay lại sau 1 Giờ!"
    },
    "en": {
